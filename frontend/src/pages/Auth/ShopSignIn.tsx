    ...
    const submit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if(email != "" && password != ""){
            const Userdata = await axios.post(
                ...
                {
                    query: `
                    query LoginShop($ShopEmail: String!,$ShopPassword: String!){
                        LoginShop(ShopEmail:$ShopEmail,ShopPassword:$ShopPassword){
                          id
                      ShopName
                      ShopEmail
                      ShopPassword
            ...
            if(Userdata.data.errors != null) alert("Email dan Password salah KON-")
                ...
                console.log(Userdata.data.data.LoginShop.id)
                sessionStorage.setItem("ID",Userdata.data.data.LoginShop.id);
